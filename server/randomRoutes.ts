...
export function registerRandomRoutes(app: Express) {
  ...
  app.patch("/api/random/matches/:id", async (req, res, next) => {
    try {
      ...
      if (b.gameMode !== undefined || b.map !== undefined || b.datetime !== undefined || b.mapHidden !== undefined || b.roundId !== undefined) {
        await randomStore.setMatchMeta(req.params.id, { gameMode: b.gameMode, map: b.map, datetime: b.datetime, mapHidden: b.mapHidden, roundId: b.roundId });
      }
