...
import { ChevronLeft, CalendarDays, Trophy, GitBranch, List, ListOrdered } from "lucide-react";
...
export function CompetitionDetailPage() {
  ...
  const hasSeason = (matches ?? []).length > 0 || (teams ?? []).length > 0;
