...
/**
 * Console admin — règles de composition (budget + points par tier) et validateur.
 */
export function ValidationAdminPage() {
  ...
  return (
    <div className="w-full px-6 py-8">
      <h1 className="text-2xl font-bold mb-6">Validation des compositions</h1>
      ...
      {competitionId && (
        <>
          <Card className="p-4 mb-8 max-w-xl">
            <h2 className="font-semibold mb-3">Règles</h2>
